 ...
 */
public interface DTRedisOperations<K, V> {
  /**
   * 设置缓存时间
   *
   * @param key 缓存的key
   ...
   */
  boolean expire(final K key, final long expireSeconds);
   ...
   * @return boolean:true|false
   */
  boolean set(final K key, final V value, long expireSeconds);
   ...
   * @return boolean:true|false
   */
  boolean set(final K key, final V value, long expired, final TimeUnit timeUnit);
   ...
   * @param value 缓存的值
   */
  void putQueue(final K key, final V value);
   ...
   * @param value 缓存的值
   */
  void putStack(final K key, final V value);
